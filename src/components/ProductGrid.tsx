...
const products = [
  ...
  },
  {
    ...
    shape: "Almond",
    price: 24.99,
    images: [nail2b, nail2, nail6b],
    rating: 4.8,
    isNew: true,
    description: "Shimmering rose gold with subtle glitter detailing. Elegant and eye-catching for any event. Each set includes 10 nails, nail glue, and a mini file.",
  },
  {
    id: "3",
    name: "Lavender Dream",
  ...
  },
  {
    ...
    rating: 4.9,
    isNew: true,
    description: "Deep, moody tones with a matte sage finish. Bold, edgy, and totally unique. Each set includes 10 nails, nail glue, and a mini file.",
  },
  {
    id: "5",
    name: "Custom Set",
